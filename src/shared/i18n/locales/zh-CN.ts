export default {
  ...
  "library.dropHint": "拖放 ePub 到此导入",
  "library.dropSubhint": "支持一次拖入多本，非 ePub 会被忽略",
  "library.duplicate": "{{count}} 本已在书库",
  "library.empty": "书库为空，点右上角「导入 ePub」或把 .epub 拖进窗口开始。",
  "library.ignored": "已忽略 {{count}} 个非 ePub：{{names}}",
