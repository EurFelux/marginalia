export default {
  ...
  "errors.replyContentFiltered": "回复被模型服务的内容过滤中止。",
  "errors.replyProviderError": "模型服务报告错误并中止了回复。",
  "errors.replyProviderErrorWithReason": "模型服务报告错误并中止了回复（{{reason}}）。",
  ...
  "reader.completeReading.failed": "无法完成这次阅读，请重试。",
  ...
  "reader.search.error": "搜索失败：{{message}}",
  "reader.search.hint": "在整本书中查找文字",
  "reader.search.next": "下一个",
  "reader.search.noChapter": "正文",
  "reader.search.noResults": "没有找到「{{query}}」",
  "reader.search.noTextLayer": "这本 PDF 是扫描版，没有文本层，无法搜索。",
  "reader.search.page": "第 {{page}} 页",
  "reader.search.pageShort": "p.{{page}}",
  "reader.search.placeholder": "搜索本书",
  "reader.search.previous": "上一个",
  "reader.search.searching": "搜索中…",
  "reader.search.tab": "搜索",
  "reader.search.truncated": "只显示前 {{count}} 条结果",
  ...
  "readingReport.generateFailed": "暂时无法生成这份报告，请重试。",
  "readingReport.generationStopped": "已停止生成，原有内容保持不变。",
  ...
  "readingReport.rereadFailed": "暂时无法重新开始阅读，请重试。",
  "readingReport.retry": "重试",
  "readingReport.saveFailed": "暂时无法保存这份报告，请重试。",
  ...
  "readingStart.failed": "无法开始这次阅读，请重试。",
