export default {
  ...
  "ai.replyFailed": "Reply failed: {{message}}",
  "ai.resend": "Resend",
  ...
  "ai.toolStep.notExecuted": "Not run",
  ...
  "errors.replyContentFiltered": "The reply was stopped by the model provider's content filter.",
  "errors.replyProviderError": "The model provider reported an error and stopped the reply.",
  "errors.replyProviderErrorWithReason":
    "The model provider reported an error and stopped the reply ({{reason}}).",
  "errors.replyTruncated":
    "The reply hit the model's output length limit and was cut off. Ask it to continue, or switch to a model with a larger output limit.",
  ...
  "reader.search.error": "Search failed: {{message}}",
  "reader.search.hint": "Find text anywhere in this book",
  "reader.search.next": "Next match",
  "reader.search.noChapter": "Text",
  "reader.search.noResults": "No matches for “{{query}}”",
  "reader.search.noTextLayer": "This PDF is a scan with no text layer, so it can't be searched.",
  "reader.search.page": "Page {{page}}",
  "reader.search.pageShort": "p.{{page}}",
  "reader.search.placeholder": "Search this book",
  "reader.search.previous": "Previous match",
  "reader.search.searching": "Searching…",
  "reader.search.tab": "Search",
  "reader.search.truncated_one": "Showing the first {{count}} match",
  "reader.search.truncated_other": "Showing the first {{count}} matches",
  ...
  "reading.openReference": "Open text for reference",
  "reading.referenceMode": "Reference mode",
  "reading.routeLoadError": "Unable to load this book.",
  "reading.routeLoading": "Loading book…",
  "reading.routeNotFound": "This book no longer exists.",
  "reading.routeSelectBook": "Select a book to read.",
  "readingReport.cancelFailed": "Unable to stop generation. Please try again.",
  "readingReport.confirmRegenerate": "Regenerate and replace",
  ...
  "readingReport.keepCurrent": "Keep current report",
  "readingReport.loadFailed": "Unable to load this reading report.",
  ...
  "readingReport.progress.tool.investigateConversation":
    "Sending an assistant into a long conversation",
  ...
  "readingReport.regenerateConfirmDescription":
    "When the new report is ready, it will replace the current content. The current report remains in place while generation runs.",
  "readingReport.regenerateConfirmTitle": "Regenerate this report?",
  ...
  "readingReport.stopGenerating": "Stop generation",
  "readingReport.stopRegenerating": "Stop regenerating",
  "readingReport.title": "Reading report",
  "readingSession.activeTime": "Active reading time",
  "readingSession.completedAt": "Completed",
  "readingSession.days_one": "{{count}} day",
  "readingSession.days_other": "{{count}} days",
